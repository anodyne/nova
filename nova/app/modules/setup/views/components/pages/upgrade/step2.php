...
<?php echo Form::open('setup/upgrade/step/3');?>
	<table class="table100 zebra">
		...
		<tbody>
			...
			<tr>
				<td>
					<strong class="fontMedium">Personal Logs</strong>
					<strong class="fontSmall errors hidden error"><br><span class="errors-content"></span></strong>
				</td>
				<td class="col-30 align-center">
					<span class="success hidden"><?php echo Html::image(MODFOLDER.'/app/modules/setup/views/design/images/tick-circle.png');?></span>
			...
			<tr>
				<td>
					<strong class="fontMedium">News</strong>
					<strong class="fontSmall errors hidden error"><br><span class="errors-content"></span></strong>
				</td>
				<td class="col-30 align-center">
					<span class="success hidden"><?php echo Html::image(MODFOLDER.'/app/modules/setup/views/design/images/tick-circle.png');?></span>
			...
			<tr>
				<td>
					<strong class="fontMedium">Missions &amp; Posts</strong>
					<strong class="fontSmall errors hidden error"><br><span class="errors-content"></span></strong>
				</td>
				<td class="col-30 align-center">
					<span class="success hidden"><?php echo Html::image(MODFOLDER.'/app/modules/setup/views/design/images/tick-circle.png');?></span>
			...
			<tr>
				<td>
					<strong class="fontMedium">Specifications</strong>
					<strong class="fontSmall errors hidden error"><br><span class="errors-content"></span></strong>
				</td>
				<td class="col-30 align-center">
					<span class="success hidden"><?php echo Html::image(MODFOLDER.'/app/modules/setup/views/design/images/tick-circle.png');?></span>
			...
			<tr>
				<td>
					<strong class="fontMedium">Tour Items</strong>
					<strong class="fontSmall errors hidden error"><br><span class="errors-content"></span></strong>
				</td>
				<td class="col-30 align-center">
					<span class="success hidden"><?php echo Html::image(MODFOLDER.'/app/modules/setup/views/design/images/tick-circle.png');?></span>
			...
			<tr>
				<td>
					<strong class="fontMedium">Docking Items (if applicable)</strong>
					<strong class="fontSmall errors hidden error"><br><span class="errors-content"></span></strong>
				</td>
				<td class="col-30 align-center">
					<span class="success hidden"><?php echo Html::image(MODFOLDER.'/app/modules/setup/views/design/images/tick-circle.png');?></span>
			...
			<tr>
				<td>
					<strong class="fontMedium">Wiki Pages</strong>
					<strong class="fontSmall errors hidden error"><br><span class="errors-content"></span></strong>
				</td>
				<td class="col-30 align-center">
					<span class="success hidden"><?php echo Html::image(MODFOLDER.'/app/modules/setup/views/design/images/tick-circle.png');?></span>
			...
			<tr>
				<td>
					<strong class="fontMedium">Uploads</strong>
					<strong class="fontSmall errors hidden error"><br><span class="errors-content"></span></strong>
				</td>
				<td class="col-30 align-center">
					<span class="success hidden"><?php echo Html::image(MODFOLDER.'/app/modules/setup/views/design/images/tick-circle.png');?></span>
			...
			<tr>
				<td>
					<strong class="fontMedium">Private Messages</strong>
					<strong class="fontSmall errors hidden error"><br><span class="errors-content"></span></strong>
				</td>
				<td class="col-30 align-center">
					<span class="success hidden"><?php echo Html::image(MODFOLDER.'/app/modules/setup/views/design/images/tick-circle.png');?></span>
				...
				<td class="align-center"><?php echo Form::radio('upgrade_pm', 1, true);?></td>
