	...
	'setup' => array(
		...
		'config' => array(
			...
			'text' => array(
				...
				'step0' => "Welcome to the Nova 3 Setup Center! Before getting started, I'll need the following information about your database before we get started:</p><ol><li>The database name</li><li>The database username</li><li>The database password</li><li>The database host</li><li>The table prefix you want to use</li></ol><p>In all likelihood, these items were supplied to you by your web host. If you do not have this information, then you'll need to contact them before you can continue.</p><p><strong>If for any reason this wized can't automatically create the database config file for you you, don't worry. All the wizard does is fill in the database information to a config file for you. You can also open <code>nova/app/modules/setup/assets/db.mysql.php</code>, copy its contents and paste them into a new file called <code>database.php</code> in the <code>:appfolder/config</code> directory if you'd rather not use this wizard.</strong>",
				'step2' => array(
					'success'=> "Alright sparky! I was able to connect to the database, so now it's time to write the config file. If you're ready, click the button below...",
				...
				'step3write' => "I was able to write the database config file. You can start to install Nova now.",
