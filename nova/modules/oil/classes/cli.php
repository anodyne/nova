<?php
/**
 * The CLI class allows interactions with the command line by accepting input
 * options, parameters and output text.
 *
 * @package		Oil
 * @category	Classes
...
class Cli {
	...
	public static function _init()
	{
		if ( ! Kohana::$is_cli)
		{
			throw new Kohana_Exception('Cli class cannot be used outside of the command line.');
		}
