...
class Oil_Scaffold {
	...
	public static function generate($args, $subfolder = 'default')
	{
		...
		if ( ! is_dir( MODPATH.'modules/oil/views/'.$subfolder))
		{
			throw new Kohana_Exception('The subfolder for scaffolding templates doesn\'t exist or is spelled wrong: '.$subfolder.' ');
		}
		...
		{
			Generate::create($app_template, file_get_contents(MODPATH . 'modules/oil/views/default/template.php'), 'view');
		}
