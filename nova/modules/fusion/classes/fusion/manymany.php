...
class Fusion_ManyMany extends Fusion_Relation {
	...
	public function __construct($from, $name, array $config)
	{
		...
		{
			throw new Kohana_Exception('Related model not found by Many_Many relation "'.$this->name.'": '.$this->model_to);
		}
	}
	...
	public function save($model_from, $models_to, $original_model_ids, $parent_saved, $cascade)
	{
		...
		{
			throw new Kohana_Exception('Assigned relationships must be an array or null, given relationship value for '.
		...
		foreach ($models_to as $key => $model_to)
		{
			...
			{
				throw new Kohana_Exception('Invalid Model instance added to relations in this model.');
			}
