...
class Fusion_Observer_Typing {
	...
	public static $type_methods = array(
		'/^varchar/uiD' => array(
			'before' => 'Fusion_Observer_Typing::type_string'
		),
		'/^(tiny|small|medium|big)?int(eger)?/uiD'
			=> 'Fusion_Observer_Typing::type_integer',
		'/^(float|double|decimal)/uiD'
			=> 'Fusion_Observer_Typing::type_float',
		'/^(tiny|medium|long)?text/' => array(
			'before' => 'Fusion_Observer_Typing::type_string'
		),
		'/^set/uiD' => array(
			'before' => 'Fusion_Observer_Typing::type_set'
		),
		'/^enum/uiD' => array(
			'before' => 'Fusion_Observer_Typing::type_set'
		),
		'/^bool(ean)?$/uiD' => array(
			'before' => 'Fusion_Observer_Typing::type_bool_to_int',
			'after'  => 'Fusion_Observer_Typing::type_bool_from_int',
		),
		'/^serialize$/uiD' => array(
			'before' => 'Fusion_Observer_Typing::type_serialize',
			'after'  => 'Fusion_Observer_Typing::type_unserialize',
		),
		'/^json$/uiD' => array(
			'before' => 'Fusion_Observer_Typing::type_json_encode',
			'after'  => 'Fusion_Observer_Typing::type_json_decode',
		),
	);
...
class InvalidContentType extends Kohana_Exception {}
