<form method="post">
	...
	<div class="control-group">
		<label class="control-label"><?php echo ucfirst(lang('short_name'));?></label>
		<div class="controls">
	...
	<div class="control-group">
		<label class="control-label"><?php echo ucfirst(lang('group'));?></label>
		<div class="controls">
			<?php echo Form::input('group', $group, array('class' => 'span1'));?>
			<p class="help-block"><?php echo lang('short.ranks.infoGroupExplain');?></p>
		</div>
	</div>
