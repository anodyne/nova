	...
	<?php foreach ($pending as $dir => $files): ?>
		...
		<div class="alert alert-block">
			<div class="btn-group pull-right">
				<a class="btn btn-mini tooltip-top install" title="<?php echo lang('action.install', 1);?>" href="#" data-location="<?php echo $location;?>"><i class="icon-ok-sign icon-50"></i></a>
				<?php if ($has_readme): ?>
					<a class="btn btn-mini show-readme tooltip-top" title="<?php echo lang('action.view readme', 2);?>" href="#"><i class="icon-info-sign icon-50"></i></a>
				<?php endif;?>
			</div>
...
<?php if (count($update) > 0): ?>
	<?php foreach ($update as $u): ?>
		...
		<div class="alert alert-info alert-block">
			<div class="btn-group pull-right">
				<a class="btn btn-mini tooltip-top update" title="<?php echo lang('action.update', 1);?>" href="#" data-location="<?php echo $u->location;?>"><i class="icon-circle-arrow-up icon-50"></i></a>
				<?php if ($has_readme): ?>
					<a class="btn btn-mini show-readme tooltip-top" title="<?php echo lang('action.view readme', 2);?>" href="#"><i class="icon-info-sign icon-50"></i></a>
				<?php endif;?>
			</div>
	...
	<table class="table table-bordered table-striped">
		...
		<?php foreach ($installed as $i): ?>
			<tr>
				...
				<td>
					<div class="btn-group">
						<a href="#" class="btn btn-mini tooltip-top" title="<?php echo lang('action.edit', 1);?>"><i class="icon-pencil icon-50"></i></a>
						<a href="#" class="btn btn-mini tooltip-top" title="<?php echo lang('action.uninstall', 1);?>"><i class="icon-ban-circle icon-50"></i></a>

						<?php if (array_key_exists($i->id, $update)): ?>
							<a href="#" class="btn btn-mini tooltip-top update" title="<?php echo lang('action.update', 1);?>" data-location="<?php echo $i->location;?>"><i class="icon-circle-arrow-up icon-50"></i></a>
						<?php endif;?>
					</div>
				</td>
			</tr>
