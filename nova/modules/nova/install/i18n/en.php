...
return array(
	'setup' => array(
		...
		'text' => array(
			'exists' => "<p class='fontMedium'>The database connection file already exists in the <code>:appfolder</code> directory. If you need to change any of the items in this file, you can either manually edit the file or delete it and start over again.</p>",
			...
			'step2' => array(
				'success'=> "<p class='fontMedium'>All right sparky! I was able to connect to the database successfully, so now it's time to write the database connection file. If you're ready, click the button below...</p>",
			...
			'step4success' => "All right sparky! You've finally finished. If you're ready, you can click on the button below to head over to the Installation Center and continuing installing Nova...",
