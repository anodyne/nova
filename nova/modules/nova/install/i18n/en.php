...
return array(
	...
	'setup.step2_nova1_failure' => "<p class='fontMedium'>Uh oh! You said you wanted to update from Nova 1, but you're trying to use the same database table prefix. Since Nova 2 uses a different database design, you have to select a different table prefix for Nova 2. Make sure you have a new database table prefix and try again.</p>",
