...
<html lang="en">
	<head>
		...
		<?php echo html::style(MODFOLDER.'/nova/install/views/design/style.css');?>
		<?php echo html::style(MODFOLDER.'/nova/install/views/design/jquery.ui.core.css');?>
		<?php echo html::style(MODFOLDER.'/nova/install/views/design/jquery.ui.theme.css');?>
