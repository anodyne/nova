...
<html lang="en">
	<head>
		...
		<?php echo html::style(MODFOLDER.'/nova/update/views/update/css/skin.css');?>
		<?php echo html::style(MODFOLDER.'/nova/update/views/update/css/jquery.ui.core.css');?>
		<?php echo html::style(MODFOLDER.'/nova/update/views/update/css/jquery.ui.theme.css');?>
