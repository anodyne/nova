...
$positions = array(
	...
	array(
		...
		'desc' => "A Navigator must always be present on the bridge of a starship. S/he is responsible for pointing the ship in the right direction and handling all navigation matters while the helmsman pilots the ship. The Chief Navigator is the senior most Navigation officer abaord, serving as a senior officer, and chief of the personnel under him/her.",
		'dept_id' => 2,
		'order' => 1,
		'open' => 1,
		'type' => 'senior'),
	...
	array(
		'name' => 'Navigator',
		'desc' => "A Navigator must always be present on the bridge of a starship, and every vessel has a number of Navigators to allow shift rotations. S/he handles all matters of navigating the ship while the helmsmen pilot the ship. Navigators report to the Chief Navigator.",
		'dept_id' => 2,
		'order' => 3,
		'open' => 4,
		'type' => 'officer'),
