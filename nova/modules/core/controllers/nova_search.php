...
class Nova_search extends Nova_main_controller {
	...
	public function index()
	{
		...
		Template::assign(array(
			'content'		=> Location::view('search_index', $this->skin, 'main', $data),
			'javascript'	=> Location::js('search_index_js', $this->skin, 'main'),
