...
$style_loc = MODFOLDER . '/views/_base/install/css/skin.css';
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	<head>
		...
		<style type="text/css">
			@import url("<?php echo base_url() . MODFOLDER .'/views/_base/install/css/jquery.ui.core.css';?>");
			@import url("<?php echo base_url() . MODFOLDER .'/views/_base/install/css/jquery.ui.theme.css';?>");
