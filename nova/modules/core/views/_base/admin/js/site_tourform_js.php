...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("a[rel*=facebox]").click(function() {
			...
			if (action == 'add')
				var location = '<?php echo site_url('ajax/add_tour_field/'. $string);?>';
			
			if (action == 'delete')
				var location = '<?php echo site_url('ajax/del_tour_field');?>/' + id + '/<?php echo $string;?>';
				
			if (action == 'edit_val')
				var location = '<?php echo site_url('ajax/edit_tour_field_value');?>/' + id + '/' + field + '/<?php echo $string;?>';
		...
		$(document).on('click', '#update', function(){
			...
			$.ajax({
				...
				type: "POST",
				url: "<?php echo site_url('ajax/save_tour_field_value');?>",
				data: data,
		...
		$(document).on('click', '.remove', function(){
			...
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('ajax/del_tour_field_value');?>",
		...
		$(document).on('click', '#add', function(){
			...
			$.ajax({
				...
				type: "POST",
				url: "<?php echo site_url('ajax/add_tour_field_value');?>",
