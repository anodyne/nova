...
<?php echo form_open('site/catalogueskins/section/edit');?>
	<table class="table100">
		<tbody>
			<tr>
				<td class="cell-label"><?php echo $label['section'];?></td>
				<td class="cell-spacer"></td>
				<td><?php echo form_dropdown('section', $values['section'], $default['section'], 'class="hud"');?></td>
			</tr>
			<tr>
				<td class="cell-label"><?php echo $label['skin'];?></td>
				<td class="cell-spacer"></td>
				<td><?php echo form_dropdown('skin', $skins, $default['skin'], 'class="hud"');?></td>
			</tr>
			...
			<tr>
				...
				<td class="cell-spacer"></td>
				<td><?php echo form_dropdown('status', $values['status'], $default['status'], 'class="hud"');?></td>
			</tr>
			<tr>
