	...
	<table class="table100">
		<tbody>
			...
			<tr>
				...
				<td class="cell-spacer"></td>
				<td><?php echo form_dropdown('dept_type', $values['type'], $default['type'], 'class="hud"');?></td>
			</tr>
			<tr>
				<td class="cell-label"><?php echo $label['parent'];?></td>
				<td class="cell-spacer"></td>
				<td><?php echo form_dropdown('dept_parent', $values['depts'], $default['parent'], 'class="hud"');?></td>
			</tr>
			<tr>
				<td class="cell-label"><?php echo $label['manifest'];?></td>
				<td class="cell-spacer"></td>
				<td><?php echo form_dropdown('dept_manifest', $values['manifest'], $default['manifest'], 'class="hud"');?></td>
			</tr>
