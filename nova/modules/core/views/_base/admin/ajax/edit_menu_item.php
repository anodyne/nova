...
<?php echo form_open('site/menus/edit');?>
	<table class="table100">
		<tbody>
			...
			<tr>
				...
				<td class="cell-spacer"></td>
				<td><?php echo form_dropdown('menu_type', $values['type'], $defaults['type'], 'class="hud"');?></td>
			</tr>
			<tr>
				<td class="cell-label"><?php echo $label['category'];?></td>
				<td class="cell-spacer"></td>
				<td><?php echo form_dropdown('menu_cat', $cats, $defaults['cat'], 'class="hud"');?></td>
			</tr>
			...
			<tr>
				...
				<td class="cell-spacer"></td>
				<td><?php echo form_dropdown('menu_need_login', $values['login'], $defaults['login'], 'class="hud"');?></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="cell-spacer"></td>
				<td><?php echo form_dropdown('menu_sim_type', $values['sim_type'], $defaults['sim_type'], 'class="hud"');?></td>
			</tr>
		</tbody>
	</table>
