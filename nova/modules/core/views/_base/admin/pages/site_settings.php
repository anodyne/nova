	...
	<div id="one">
		<?php echo form_open('site/settings');?>
			...
			<div class="indent-left">
				...
				<p>
					<kbd>
						<span><?php echo $label['type'];?>&nbsp;</span>
						<?php echo anchor('site/simtypes', '['. $label['edit'] .']', array('class' => 'fontTiny edit'));?>
					</kbd>
			...
			<div class="indent-left">
				<p>
					<kbd>
						<span><?php echo $label['hosting_company'];?>&nbsp;</span>
				...
				<p>
					<kbd>
						<span><?php echo $label['access_log_purge']; ?>&nbsp;</span>
	...
	<div id="two">
		<?php echo form_open('site/settings/1');?>
			...
			<div class="indent-left">
				...
				<p>
					<kbd>
						<span><?php echo $label['online'];?>&nbsp;</span>
				...
				<p>
					<kbd>
						<span><?php echo $label['requirement'];?>&nbsp;</span>
				...
				<p>
					<kbd>
						<span><?php echo $label['posts_participants'];?>&nbsp;</span>
	...
	<div id="three">
		<?php echo form_open('site/settings/2');?>
			...
			<div class="indent-left">
				...
				<p>
					<kbd>
						<span><?php echo $label['count_format'];?>&nbsp;</span>
