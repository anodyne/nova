...
<?php if (isset($page)): ?>
				...
				<ul>
					<li>
						<a href="#" myAction="comment" rel="facebox" myID="<?php echo $id;?>" class="image">
							<?php echo img($images['comment']) .' <span>'. $label['addcomment'].'</span>';?>
						</a>
					</li>

					<?php if ($edit): ?>
						<li>
							<?php echo anchor('wiki/page/'.$id.'/edit', img($images['edit']).' <span>'.$label['edit'].'</span>', array('class' => 'image edit'));?>
						</li>
					<?php endif;?>
				</ul>
			</div>
	...
	<?php endif;?>
			...
			<div id="one">
				...
				<?php echo text_output($page['content'], 'div', 'prose', false);?>
