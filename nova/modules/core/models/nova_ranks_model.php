...
abstract class Nova_ranks_model extends CI_Model
{
    ...
    {
        $query = $this->db->get_where('ranks', array('rank_id' => $id));
    ...
    {
        $query = $this->db->insert('ranks', $data);

        $this->dbutil->optimize_table('ranks');
    ...
    public function update_rank($id = '', $data = '')
    {
        ...
        $query = $this->db->update('ranks', $data);
    ...
    {
        $query = $this->db->delete('ranks', array('rank_id' => $id));
