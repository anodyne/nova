...
abstract class Nova_positions_model extends CI_Model
{
    ...
    {
        $query = $this->db->get_where('positions', array('pos_id' => $id));
    ...
    {
        $query = $this->db->insert('positions', $data);

        $this->dbutil->optimize_table('positions');
    ...
    {
        $query = $this->db->delete('positions', array('pos_id' => $id));
