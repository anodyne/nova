<?php /*<style type="text/css">
			<?php if (!is_file(APPPATH .'views/'. $skin .'/main/css/jquery.colorbox.css')): ?>
				<?php $colorbox_css = base_url() . APPFOLDER .'/assets/js/css/jquery.colorbox.css';?>
			<?php else: ?>
				<?php $colorbox_css = base_url() . APPFOLDER .'/views/'. $skin .'/main/css/jquery.colorbox.css';?>
			<?php endif;?>
			
			<?php if (!is_file(APPPATH .'views/'. $skin .'/main/css/jquery.facebox.css')): ?>
				@import url("<?php echo base_url() . APPFOLDER .'/assets/js/css/jquery.facebox.css';?>");
			<?php else: ?>
				@import url("<?php echo base_url() . APPFOLDER .'/views/'. $skin .'/main/css/jquery.facebox.css';?>");
			<?php endif;?>
			
			@import url("<?php echo base_url() . APPFOLDER .'/assets/js/css/ui.core.css';?>");
			
			<?php if (!is_file(APPPATH .'views/'. $skin .'/main/css/ui.theme.css')): ?>
				@import url("<?php echo base_url() . APPFOLDER .'/assets/js/css/ui.theme.css';?>");
			<?php else: ?>
				@import url("<?php echo base_url() . APPFOLDER .'/views/'. $skin .'/main/css/ui.theme.css';?>");
			<?php endif;?>
		</style>
