...
<div id="container">
	...
	<div class="content">
		<div id="loading" class="hidden">
			<img src="<?php echo url::base().MODFOLDER;?>/nova/update/views/update/images/loading-circle-large.gif" alt="" />
			<br />
			<strong><?php echo ucfirst(__('processing'));?>...</strong>
		</div>
		
		<div id="loaded" class="UITheme">
			<?php if ((Request::instance()->action == 'step' or Request::instance()->action == 'nova1') and Request::instance()->param('id') > 0): ?>
				<div id="amount">
