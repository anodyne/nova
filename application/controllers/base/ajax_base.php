...
class Ajax_base extends Controller {
	...
	*/
	...
	{
		$allowed = $this->auth->check_access('site/bioform', false);
	...
	function add_catalogue()
	{
		...
		{
			case 'ranks':
				$allowed = $this->auth->check_access('site/catalogueranks', false);
			...
			case 'skins':
				$allowed = $this->auth->check_access('site/catalogueskins', false);
	...
	{
		$allowed = $this->auth->check_access('characters/coc', false);
	...
	{
		$allowed = $this->auth->is_logged_in();
	...
	function add_deck()
	{
		$allowed = $this->auth->check_access('manage/decks', false);
	...
	function add_dept()
	{
		$allowed = $this->auth->check_access('manage/depts', false);
	...
	{
		$allowed = $this->auth->check_access('site/dockingform', false);
	...
	{
		$allowed = $this->auth->check_access('site/menus', false);
	...
	{
		$allowed = $this->auth->check_access('manage/missions', false);
	...
	{
		$allowed = $this->auth->check_access('manage/positions', false);
	...
	function add_rank()
	{
		$allowed = $this->auth->check_access('manage/ranks', false);
	...
	{
		$allowed = $this->auth->check_access('site/roles', false);
	...
	{
		$allowed = $this->auth->check_access('site/messages', false);
	...
	{
		$allowed = $this->auth->check_access('site/specsform', false);
	...
	{
		$allowed = $this->auth->check_access('site/tourform', false);
	...
	{
		$allowed = $this->auth->check_access('site/settings', false);
	...
	function approve()
	{
		...
		{
			case 'posts':
				$allowed = $this->auth->check_access('manage/posts', false);
				$level = $this->auth->get_access_level('manage/posts');
			...
			case 'logs':
				$allowed = $this->auth->check_access('manage/logs', false);
				$level = $this->auth->get_access_level('manage/logs');
			...
			case 'news':
				$allowed = $this->auth->check_access('manage/news', false);
				$level = $this->auth->get_access_level('manage/news');
			...
			case 'posts_comment':
				$allowed = $this->auth->check_access('manage/comments', false);
			...
			case 'award_nomination':
				$allowed = $this->auth->check_access('user/nominate', false);
				$level = $this->auth->get_access_level('user/nominate');
			...
			case 'character':
				$allowed = $this->auth->check_access('characters/index', false);
			...
			case 'docking':
				$allowed = $this->auth->check_access('manage/docked', false);
	...
	*/
	...
	function del_award()
	{
		$allowed = $this->auth->check_access('manage/awards', false);
	...
	function del_ban()
	{
		$allowed = $this->auth->check_access('site/bans', false);
	...
	{
		$allowed = $this->auth->check_access('characters/awards', false);
	...
	{
		$allowed = $this->auth->check_access('characters/bio', false);
	...
	{
		$allowed = $this->auth->check_access('site/manifests', false);
	...
	function del_npc()
	{
		$allowed = $this->auth->check_access('characters/npcs', false);
	...
	{
		$allowed = $this->auth->check_access('manage/specs', false);
	...
	{
		$allowed = $this->auth->check_access('manage/tour', false);
	...
	function del_user()
	{
		$allowed = $this->auth->check_access('user/account', false);
	...
	{
		$allowed = $this->auth->check_access('wiki/categories', false);
	...
	{
		$allowed = $this->auth->check_access('wiki/page', false);
	...
	*/
	...
	{
		$allowed = $this->auth->is_sysadmin($this->session->userdata('userid'));
