...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo base_url() . APPFOLDER;?>/assets/js/css/uniform.default.css" />
		
		<script type="text/javascript" src="<?php echo base_url() . APPFOLDER;?>/assets/js/jquery.uniform.js"></script>
