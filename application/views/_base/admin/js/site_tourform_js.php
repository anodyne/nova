<script type="text/javascript">
	$(document).ready(function(){
		...
		$("a[rel*=facebox]").click(function() {
			...
			if (action == 'add')
				var location = '<?php echo site_url('ajax/add_tour_field');?>';
			
			if (action == 'delete')
				var location = '<?php echo site_url('ajax/del_tour_field');?>/' + id;
				
			if (action == 'edit_val')
				var location = '<?php echo site_url('ajax/edit_tour_field_value');?>/' + id + '/' + field;
