...
$lang['fbx_item_players_role'] = 'players with this role';
...
$lang['fbx_content_info_players_with_role'] = "The following players have been granted the <strong>%s</strong> access role:";
...
$lang['fbx_content_del_role'] = "Are you sure you want to delete the <strong>%s</strong> role? This action will affect player accounts, is permanent and cannot be undone! Please select the new role that all players currently with this role will be reassigned to.";
...
$lang['fbx_content_del_catalogue_rank'] = "Are you sure you want to delete the <strong>%s</strong> rank set? This action will affect the entire system, is permanent and cannot be undone! Please select a new rank set to update all players currently using this rank set to.";
...
$lang['fbx_content_del_catalogue_skinsec'] = "Are you sure you want to delete the %s <strong>%s</strong> theme? This action will affect the entire system, is permanent and cannot be undone! Please select a new theme to update all players currently using this theme to.";
