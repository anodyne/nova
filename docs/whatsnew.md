It's almost impossible to highlight everything that's changed in Nova 3, but the below list represents some of the biggest changes that have been made for this release of Nova.
